...
########## COMPONENTS TARGET PROPERTIES Debug ########################################
    ...
    ########## COMPONENT benchmark::benchmark_main #############
        ...
        set_property(TARGET benchmark::benchmark_main PROPERTY INTERFACE_LINK_OPTIONS
                     $<$<CONFIG:Debug>:${benchmark_benchmark_benchmark_main_LINKER_FLAGS_DEBUG}> APPEND)
        set_property(TARGET benchmark::benchmark_main PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                     $<$<CONFIG:Debug>:${benchmark_benchmark_benchmark_main_INCLUDE_DIRS_DEBUG}> APPEND)
        set_property(TARGET benchmark::benchmark_main PROPERTY INTERFACE_LINK_DIRECTORIES
                     $<$<CONFIG:Debug>:${benchmark_benchmark_benchmark_main_LIB_DIRS_DEBUG}> APPEND)
        set_property(TARGET benchmark::benchmark_main PROPERTY INTERFACE_COMPILE_DEFINITIONS
                     $<$<CONFIG:Debug>:${benchmark_benchmark_benchmark_main_COMPILE_DEFINITIONS_DEBUG}> APPEND)
        set_property(TARGET benchmark::benchmark_main PROPERTY INTERFACE_COMPILE_OPTIONS
                     $<$<CONFIG:Debug>:${benchmark_benchmark_benchmark_main_COMPILE_OPTIONS_DEBUG}> APPEND)
    ...
    ########## COMPONENT benchmark::benchmark #############
        ...
        set_property(TARGET benchmark::benchmark PROPERTY INTERFACE_LINK_OPTIONS
                     $<$<CONFIG:Debug>:${benchmark_benchmark_benchmark_LINKER_FLAGS_DEBUG}> APPEND)
        set_property(TARGET benchmark::benchmark PROPERTY INTERFACE_INCLUDE_DIRECTORIES
                     $<$<CONFIG:Debug>:${benchmark_benchmark_benchmark_INCLUDE_DIRS_DEBUG}> APPEND)
        set_property(TARGET benchmark::benchmark PROPERTY INTERFACE_LINK_DIRECTORIES
                     $<$<CONFIG:Debug>:${benchmark_benchmark_benchmark_LIB_DIRS_DEBUG}> APPEND)
        set_property(TARGET benchmark::benchmark PROPERTY INTERFACE_COMPILE_DEFINITIONS
                     $<$<CONFIG:Debug>:${benchmark_benchmark_benchmark_COMPILE_DEFINITIONS_DEBUG}> APPEND)
        set_property(TARGET benchmark::benchmark PROPERTY INTERFACE_COMPILE_OPTIONS
                     $<$<CONFIG:Debug>:${benchmark_benchmark_benchmark_COMPILE_OPTIONS_DEBUG}> APPEND)
